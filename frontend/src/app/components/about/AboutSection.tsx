...
import AboutGallery from "@/app/about/AboutGallery";
...
export default async function AboutSection() {
  ...
  return (
    <div className="space-y-24">
      <section
        id="about"
        className="mx-auto w-full max-w-5xl scroll-mt-32"
      ...
      <section className="mx-auto w-full max-w-5xl" aria-labelledby="projects-heading">
        <div className="flex items-center justify-between">
          <div>
            <span className="text-xs uppercase tracking-[0.3em] text-accent">Projects</span>
            <h3 id="projects-heading" className="mt-3 text-2xl font-semibold text-foreground md:text-3xl">
              最近の制作
            </h3>
          </div>
          <Link
      ...
      <section className="mx-auto w-full max-w-5xl" aria-labelledby="gallery-heading">
        <div className="flex items-center justify-between">
          <div>
            <span className="text-xs uppercase tracking-[0.3em] text-accent">Gallery</span>
            <h3 id="gallery-heading" className="mt-3 text-2xl font-semibold text-foreground md:text-3xl">
              作品集
            </h3>
          </div>
          <Link
