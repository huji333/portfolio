...
export const HEADER_STYLE_PRESETS: Record<'light' | 'solid', HeaderStyles> = {
  light: {
    header:
      'border-b border-foreground/10 bg-background/95 text-foreground backdrop-blur-sm md:border-transparent md:bg-transparent md:text-white',
  ...
  solid: {
    header: 'border-b border-foreground/10 bg-background/95 text-foreground backdrop-blur-sm',
